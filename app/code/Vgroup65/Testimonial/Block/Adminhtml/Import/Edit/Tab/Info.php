...
class Info extends Generic implements TabInterface {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField(
            ...
            'name' => 'file',
            'required' => true,
            'note' => '<a href="' . $this->getUrl('testimonials/samplefile/index') . '">Click to download sample file</a><br><p>Please mention Testimonial ID if you want to update the existing testimonial(s).</p>',
                ]
        );
