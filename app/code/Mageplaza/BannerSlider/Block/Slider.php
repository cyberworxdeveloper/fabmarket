...
class Slider extends Template
{
    ...
    public function getSliderCategoriesId()
    {
        if ($this->getSliderCategorie()) {
            return $this->getSliderCategorie()->getSliderCategoriesId();
        }
    ...
    public function getBannerCollection()
    {
        $collection = [];
        if ($this->getSliderId()) {
            $collection = $this->helperData->getBannerCollection($this->getSliderId());
