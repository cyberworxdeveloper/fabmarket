...
class ProductsList extends \Magento\CatalogWidget\Block\Product\ProductsList
{
	...
	protected function _getFeaturedCollection()
    {
        $collection = $this->_getAllProductProductCollection();        
		$collection->addAttributeToFilter('visibility', '4');
		$collection->addAttributeToFilter('featured_show', 'Yes');
	...
	protected function _getRecomCollection()
    {
        $collection = $this->_getAllProductProductCollection();        
		$collection->addAttributeToFilter('visibility', '4');
		$collection->addAttributeToFilter('featured_show', 'Yes');
	...
	protected function _getBrowserCollection()
    {
					...
					$field  = 'customer_id';
					$orderCollection = $orderCollectionFactory->addAttributeToSelect('*')->addFieldToFilter($field, $customerSession->getCustomerId());
					...
					if ($orderCollection && count($orderCollection) > 0) {
						...
						//echo "welcom1"; print_r($productIds);exit;
    ...
    protected function _getMostViewedCollection()
    {
					...
					//echo "welcome";print_r($productIds);exit;
            ...
            switch ($displayType) {
                case 'all_products':
				  ...
				  case 'featured_products':
                    $collection = $this->_getFeaturedCollection();
                    break;
					 case 'artist_of_week':
                    ...
                    break;
					 ...
					 case 'recom_products':
                    $collection = $this->_getRecomCollection();
                    break;
					
					case 'browser_products':
                    $collection = $this->_getBrowserCollection();
                    break;
