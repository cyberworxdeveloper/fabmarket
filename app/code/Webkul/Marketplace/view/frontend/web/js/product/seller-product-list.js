...
define([
    ...
    'mage/calendar'
            ...
            initialize: function () {
                ...
                $('body').delegate('#mass-delete-butn','click', function (e) {
                    ...
                    if (flag === 0) {
						...
						e.preventDefault();
                        $(".fab_marketplace_product_delete_bg").css({
				"opacity": "1", 
    				"visibility": "visible"
			});
		...
		$('body').delegate('.delte_mass_list','click', function () { 
			$('#form-productlist-massdelete').submit();
		});

		$('body').delegate('.delte_mass_list_cancel','click', function () { 
			 $(".fab_marketplace_product_delete_bg").css({
				"opacity": "0", 
    				"visibility": "hidden"
			});
