...
class CustomerRegisterSuccessObserver implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        try {
			...
			$shoptitledata=$paramData['shoptitle'];
			$profileurldata=$paramData['profileurl'];
			$seller_countrydata=$paramData['seller_country'];
            ...
            if (!empty($paramData['is_seller']) && !empty($paramData['profileurl']) && $paramData['is_seller'] == 1) {
                ...
                if (!$profileurlcount->getSize()) {
                    ...
                    if ($partnerApprovalStatus) {
						...
						$emailTemplateVariables['myvar12'] = $paramData['shoptitle'];
						$emailTemplateVariables['myvar13'] = $paramData['profileurl'];
						$emailTemplateVariables['myvar14'] = $paramData['seller_country'];
