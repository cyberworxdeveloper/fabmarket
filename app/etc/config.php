...
return [
    'modules' => [
        ...
        'Adyen_Payment' => 1,
        'Aitoc_Core' => 1,
        'Aitoc_TwoFactorAuthentication' => 1,
        'Amazon_Core' => 1,
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'Apptrian_Minify' => 1,
        ...
        'Cyberworx_Ajaxcontroller' => 1,
        'Cyberworx_Checklogin' => 1,
        'Cyberworx_CustomerAccount' => 1,
        'Cyberworx_CustommailOrder' => 1,
        'Cyberworx_Customtax' => 1,
        'Cyberworx_Newshows' => 1,
        'Cyberworx_Popularshow' => 1,
        'Cyberworx_Recentlyviewed' => 1,
        'Cyberworx_Rshow' => 1,
        'Dotdigitalgroup_Email' => 1,
        'Dotdigitalgroup_Chat' => 1,
        'Fabmarket_Artistoftheweek' => 1,
        'Fabmarket_Browsinghistory' => 1,
        'Fabmarket_Downloadepisode' => 1,
        'Fabmarket_Episode' => 1,
        'Fabmarket_Sidebarremoveitem' => 1,
        'Fabmarket_Subscribe' => 1,
        'Fabmarket_Subscribedetails' => 1,
        'Forgotpwd_Resetpwd' => 1,
        'Klarna_Core' => 1,
        'Klarna_Ordermanagement' => 1,
        'Klarna_Kp' => 1,
        'Ktree_CustomerAttribute' => 0,
        'Magento_PaypalReCaptcha' => 1,
        'MSP_TwoFactorAuth' => 1,
        'Magecheckout_Customminicart' => 1,
        'Magefan_Community' => 1,
        'Magefan_Blog' => 1,
        'Magefan_WysiwygAdvanced' => 1,
        'Magenticians_Ajaxmodule' => 1,
        'Mageplaza_Core' => 1,
        ...
        'Mageplaza_Smtp' => 1,
        'MaxMage_InternationalTelephoneInput' => 0,
        'Meetanshi_SocialMetaTag' => 1,
        'Rsgitech_Customer' => 1,
        'Suntech_Customer' => 1,
        'Temando_Shipping' => 1,
        'Thai_S3' => 1,
